...
namespace VideoProcessor1
{
    class Program
    {
        ...
        private static readonly string _subscriptionName = "Customer1Subscriber";
        ...
        private static void ProcessVideo(string blobName)
        {
            ...
            string tempOutputFileName = Path.Combine(Path.GetTempPath(), blobName.Replace(".mp4", ".avi"));
            ...
            ffMpeg.ConvertMedia(tempInputFileName, tempOutputFileName, Format.avi);
            CloudBlockBlob convertedBlob = cloudBlobContainer.GetBlockBlobReference(blobName.Replace(".mp4", ".avi"));
            convertedBlob.Properties.ContentType = "video/x-msvideo";
