...
namespace VideoProcessor4
{
    class Program
    {
        ...
        private static readonly string _subscriptionName = "Customer4Subscriber";
        ...
        static void Main(string[] args)
        {
            ...
            SqlFilter subscriptionFilter = new SqlFilter("Customer = 'Customer4'");
